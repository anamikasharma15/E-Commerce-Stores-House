  ...
  //by destructuring product object
    ...
    div.classList.add("product");
     ...
     <img class="product-image" src=${image}></img>
       ...
       <h5>Total-Rating :<span><i class="fas fa-user-friends text-success "></i> ${count}</span>  </h5>
      <h6>Average-rating:<span><i class="fas fa-star text-danger "></i></span>
                      <span><i class="fas fa-star text-danger "></i></span>
                      <span><i class="fas fa-star text-danger "></i></span>
                      <span><i class="fas fa-star text-danger "></i></span>
                      <span><i class="fas fa-star text-white"></i></span> ${rate} </h6>
